...
import type { DesignPackage, SVGGenerationRequest, MotifData } from '../types';
...
function isAnimalMotif(motif: MotifData | undefined | null): boolean {
          ...
          <div className="w-full max-w-sm aspect-square relative z-10">
            {error ? (
              ...
              <div
                ...
                dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(currentSVG, { USE_PROFILES: { svg: true } }) }}
              />
            ) : (
